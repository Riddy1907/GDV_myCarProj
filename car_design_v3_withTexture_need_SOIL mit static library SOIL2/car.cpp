...
void wiper1()
{
	glPushMatrix();
		...
		parallelepiped(0.01f, 0.26f, 0.01f, 0, 0.13f, 0);
		glTranslatef(-0.01f, 0.26f, 0);
		glRotatef(5, 1, 0, 0);
		glColor4f(0.4f, 0.4f, 0.4f, 1);
		parallelepiped(0.01f, 0.4f, 0.02f, 0, 0, 0);
	glPopMatrix();
}
...
void boot_door()
{
	...
	glNormal3f(-0.70710678f, 0.70710678f, 0);
	glBegin(GL_QUADS);
...
void drawcar()
{
	...
	parallelepiped(0.15f, 0.15f, 1.6f, 2.025f, 0.275f, 0);
